...
class IncomesControllerTest < ActionController::TestCase
  ...
  test "should create income" do
    assert_difference('Income.count') do
      post :create, income: { amount: @income.amount, date_of_income: @income.date_of_income }
    end
  ...
  test "should update income" do
    patch :update, id: @income, income: { amount: @income.amount, date_of_income: @income.date_of_income }
    assert_redirected_to income_path(assigns(:income))
  end
